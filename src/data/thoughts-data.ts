...
export const thoughts: Thought[] = [
  {
    ...
    content: [
      ...
      'TanStack Query (formerly React Query) handles data fetching and state management with powerful caching capabilities. TanStack Start enables full-stack application development with server-side rendering support. TanStack Router provides type-safe routing with excellent TypeScript integration.',
  ...
  },
  {
    ...
    content: [
      'Testing is an essential part of website development to ensure functionality, performance, and reliability. It involves different types of tests including unit testing, integration testing, and end-to-end testing.',
      
      'Proper testing helps developers catch bugs early, improve user experience, and maintain code quality across the application lifecycle. By implementing comprehensive testing strategies, teams can deliver more reliable applications, reduce production bugs, and build confidence in their codebase.'
    ],
